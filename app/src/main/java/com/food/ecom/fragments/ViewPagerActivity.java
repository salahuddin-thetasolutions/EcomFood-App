...
import com.food.ecom.fragments.HackyViewPager;
...
public class ViewPagerActivity extends Activity {
    ...
    static class SamplePagerAdapter extends PagerAdapter {
       /* Here I'm adding the demo pics, but you can add your Item related pics , just get your pics based on itemID (use asynctask) and
        ...
        private static final String[] sDrawables = com.food.ecom.utility.ImageUrlUtils.getImageUrls();
        ...
        public View instantiateItem(ViewGroup container, int position) {
            com.food.ecom.photoview.view.PhotoView photoView = new com.food.ecom.photoview.view.PhotoView(container.getContext());
