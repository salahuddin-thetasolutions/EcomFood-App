...
public class ImageUrlUtils {
    ...
    static ArrayList<Product> cartListProducts = new ArrayList<>();
    ...
    // Methods for Product Cart
    public void addCartListProduct(Product oProduct) {
        this.cartListProducts.add(0,oProduct);
    }
    public ArrayList<Product> getCartListProduct(){ return this.cartListProducts; }
